function main_Arm4D_Decomposition()
...
dCar = Arm4D_Decomposition([0, 0, 0, 0], uMax, dMax, grid_min, grid_max); %do dStep3 here
...
csvwrite('Arm4D_Decomposition.csv',data);
...
v = VideoWriter('Arm4D_Decomposition.mp4','MPEG-4');
