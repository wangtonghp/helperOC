...
function dx = dynamics_cell_helper(obj, x, u, d, dims, dim)
    ...
    switch dim
      ...
      case 3 % acceleration of angle th1
        ...
        [ddth1, ~] = arrayfun(@acceleration_helper, reshape(x{1}, [1, flatSize]), ...
            ...
            reshape(u{2}, [1, flatSize]), reshape(d{1}, [1, flatSize]), ...
            reshape(d{2}, [1, flatSize]));
    ...
    function [ddth1, ddth2] = acceleration_helper(th1, th2, dth1, dth2, u1, u2, d1, d2)
